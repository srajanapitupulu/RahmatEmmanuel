...
class GiveViewController: UIViewController {
  ...
  @IBOutlet weak var webVwGive:UIWebView!
  ...
  override func viewDidLoad() {
    ...
    let url = NSURL (string: "http://rahmatemmanuel.com/give-webview/")
    let requestObj = NSURLRequest(URL: url!);
    self.webVwGive.loadRequest(requestObj)
...
extension GiveViewController:UIWebViewDelegate {
...
extension GiveViewController:DelegateLeftMenu {
  func doGoToHome(){
  ...
  func doGoToJoin() {
    ...
    joinVC = sbMain.instantiateViewControllerWithIdentifier("JoinViewController") as! JoinViewController
    self.presentViewController(joinVC, animated: true, completion: nil)
  }
...
extension GiveViewController:DelegateHeaderView {
  func doOpenLeftMenu() {
